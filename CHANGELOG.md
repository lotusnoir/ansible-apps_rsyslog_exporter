...
## [3.2.1](https://github.com/lotusnoir/ansible-apps_rsyslog_exporter/compare/3.2.0...3.2.1) - 2025-11-29

### Commits

- add no changes on run flag to keep idempotence [`04bfe66`](https://github.com/lotusnoir/ansible-apps_rsyslog_exporter/commit/04bfe66fe5dd33ecfa840d5e594520b4ac85d62a)
